...
if __name__ == '__main__':
    ...
    parser.add_argument('partnumber', help='suffix to 501920 series number (e.g. 3001)', type=str, nargs=1)
    ...
    footprint_name = 'Molex_SlimStack_Plug_2x{pc:02g}_Pitch0.5mm_501920-{pn:s}'.format(pc=pincount/2, pn=partnumber)
