...
if __name__ == '__main__':
    ...
    # common settings
    makeCrystalAll(footprint_name="Crystal_AT310_l10.0mm_d3.0mm_Horizontal",
    ...
    makeCrystalRoundVert(footprint_name="Crystal_AT310_l10.0mm_d3.0mm_Vertical",
    ...
    makeCrystalAll(footprint_name="Crystal_C26-LF_l6.5mm_d2.1mm_Horizontal",
                ...
                offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalRoundVert(footprint_name="Crystal_C26-LF_l6.5mm_d2.1mm_Vertical",
    ...
    makeCrystalAll(footprint_name="Crystal_C38-LF_l8.0mm_d3.0mm_Horizontal",
                ...
                lib_name="Crystals",
                offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalRoundVert(footprint_name="Crystal_C38-LF_l8.0mm_d3.0mm_Vertical",
    ...
    makeCrystalAll(footprint_name="Crystal_DS26_l6.0mm_d2.0mm_Horizontal",
                ...
                offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalRoundVert(footprint_name="Crystal_DS26_l6.0mm_d2.0mm_Vertical",
    ...
    makeCrystalAll(footprint_name="Crystal_DS15_l5.0mm_d1.5mm_Horizontal",
                ...
                offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalRoundVert(footprint_name="Crystal_DS15_l5.0mm_d1.5mm_Vertical",
    ...
    makeCrystalAll(footprint_name="Crystal_DS10_l4.3mm_d1.0mm_Horizontal",
                ...
                offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalRoundVert(footprint_name="Crystal_DS10_l4.3mm_d1.0mm_Vertical",
    ...
    makeCrystalHC49Vert(footprint_name="Crystal_HC52-6mm_Vertical", pins=2,
                        ...
                        lib_name="Crystals",
                        offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalHC49Vert(footprint_name="Resonator_muRata_DSN6-3pin", pins=3,
                        ...
                        lib_name="Crystals",
                        offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalHC49Vert(footprint_name="Resonator_muRata_DSS6-3pin", pins=3,
                        rm=5, pad_size=1.7, ddrill=1, pack_width=7, pack_height=2.54,
                        innerpack_width=7, innerpack_height=2.54,
                        ...
                        lib_name="Crystals",
                        offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalHC49Vert(footprint_name="Resonator_muRata_CSTLSxxxG-3pin", pins=3,
                        ...
                        lib_name="Crystals",
                        offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalHC49Vert(footprint_name="Resonator_muRata_CSTLSxxxX-3pin", pins=3,
                        ...
                        lib_name="Crystals",
                        offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalHC49Vert(footprint_name="Resonator_w10mm_h5mm_2pin", pins=2,
                        ...
                        lib_name="Crystals",
                        offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalHC49Vert(footprint_name="Resonator_w10mm_h5mm_3pin", pins=3,
                        rm=5, pad_size=1.5, ddrill=0.8, pack_width=10, pack_height=5,
                        innerpack_width=10, innerpack_height=5,
                        tags=standardtagsres + "",
                        ...
                        lib_name="Crystals",
                        offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalHC49Vert(footprint_name="Resonator_w7.0mm_h2.5mm_3pin", pins=3,
                        ...
                        lib_name="Crystals",
                        offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalHC49Vert(footprint_name="Resonator_w7.0mm_h2.5mm_2pin", pins=2,
                        rm=5, pad_size=1.7, ddrill=1, pack_width=7, pack_height=2.5,
                        innerpack_width=7, innerpack_height=2.5,
                        tags=standardtagsres + "",
                        description="Ceramic Resomator/Filter 7.0x2.5mm^2",
                        lib_name="Crystals",
                        offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalHC49Vert(footprint_name="Resonator_w8.0mm_h3.5mm_3pin", pins=3,
                        ...
                        lib_name="Crystals",
                        offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalHC49Vert(footprint_name="Resonator_w8.0mm_h3.5mm_2pin", pins=2,
                        rm=5, pad_size=1.7, ddrill=1, pack_width=8, pack_height=3.5,
                        innerpack_width=8, innerpack_height=3.5,
                        tags=standardtagsres + "",
                        description="Ceramic Resomator/Filter 8.0x3.5mm^2",
                        lib_name="Crystals",
                        offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalHC49Vert(footprint_name="Resonator_w6.0mm_h3.0mm_3pin", pins=3,
                        ...
                        lib_name="Crystals",
                        offset3d=[0, 0, 0], scale3d=[1, 1, 1], rotate3d=[0, 0, 0])
    makeCrystalHC49Vert(footprint_name="Resonator_w6.0mm_h3.0mm_2pin", pins=2,
                        rm=5, pad_size=1.7, ddrill=1, pack_width=6, pack_height=3.0,
                        innerpack_width=6, innerpack_height=3.0,
                        tags=standardtagsres + "",
                        description="Ceramic Resomator/Filter 6.0x3.0mm^2",
