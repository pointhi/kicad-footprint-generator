...
#FP name strings
part_base = "B{n:02}B-J21DK-GG" #JST part number format string
...
def generate_one_footprint(pins, configuration):
    ...
    m1 = Pad(at=[0, mh_y],layers=["*.Cu",'*.Mask'],shape=Pad.SHAPE_CIRCLE,type=Pad.TYPE_THT,size=3, drill=2)
    m2 = Pad(at=[A, mh_y],layers=["*.Cu",'*.Mask'],shape=Pad.SHAPE_CIRCLE,type=Pad.TYPE_THT,size=3, drill=2)
